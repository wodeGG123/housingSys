...
<div>
  <x-header>项目详情
    ...
    <div class="detail">
      ...
      <div v-if="content.listReplys&&content.listReplys.length > 0" >
      ...
      <div class="content" v-if="content.listReplys&&content.listReplys.length=== 0">暂无相关数据！</div>
      <div class="title">
      ...
      <div class="content" v-if="content.listItems&&content.listItems.length=== 0">暂无相关数据！</div>
      <div class="title">
      ...
      <div class="content" v-if="content.imgs&&content.imgs.length=== 0">暂无相关图片！</div>
    </div>
</div>
</template>
...
.content{
   background: #ffffff;
    ...
    margin-bottom: 8px;
    color: #999;
    /deep/.vux-x-switch.weui-cell_switch{
      padding: 0;
    }
    /deep/.weui-switch{
          width: 44px;
